    ...
    <Layout>
      ...
      <section className="relative h-[40vh] min-h-[300px] bg-primary">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <AnimatedSection direction="up" delay={0.1} className="max-w-2xl">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl font-display font-bold">Giá trị cốt lõi</h2>
          </AnimatedSection>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12">
            <h2 className="text-3xl font-display font-bold">Đội ngũ lãnh đạo</h2>
          </AnimatedSection>
